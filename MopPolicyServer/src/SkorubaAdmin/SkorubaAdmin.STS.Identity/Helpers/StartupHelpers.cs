...
using SkorubaAdmin.STS.Identity.Configuration;
using SkorubaAdmin.STS.Identity.Configuration.ApplicationParts;
using SkorubaAdmin.STS.Identity.Configuration.Constants;
using SkorubaAdmin.STS.Identity.Configuration.Interfaces;
using SkorubaAdmin.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace SkorubaAdmin.STS.Identity.Helpers
{
