...
using SkorubaDuendeIdentityServer.STS.Identity.Configuration;
using SkorubaDuendeIdentityServer.STS.Identity.Configuration.ApplicationParts;
using SkorubaDuendeIdentityServer.STS.Identity.Configuration.Constants;
using SkorubaDuendeIdentityServer.STS.Identity.Configuration.Interfaces;
using SkorubaDuendeIdentityServer.STS.Identity.Helpers.Localization;
using SkorubaDuendeIdentityServer.STS.Identity.Services;

namespace SkorubaDuendeIdentityServer.STS.Identity.Helpers
{
